    ...
    <div class="home-content">
      <div class="container">
        ...
        if ($_SERVER["REQUEST_METHOD"]=="POST") {
          ...
          $sql="insert into dokter (nama_dokter,spesialis,no_telp,alamat) values('$nama_dokter','$spesialis','$no_telp','$alamat');";
        ...
        <div class="card">
          <div class="card-body">
            <h4 class="card-title" style="text-align: center;">Input Data Dokter</h4>
            <hr>
