  ...
  <section class="home-section">
    <nav>
      <div class="sidebar-button">
        ...
        <span class="dashboard">List Obat</span>
      </div>
    ...
    <div class="home-content">
      <div class="container">
        <div class="card">
          <div class="card-body">
            <h5 class="card-title mb-4" style="text-align: center;">List Obat</h5>
            <hr>
            <?php
            include "koneksi.php";

            if (isset($_GET['kode_obat'])) {
              $kode_obat=htmlspecialchars($_GET["kode_obat"]);
            ...
            <table class="table table-bordered table-hover">
              ...
              <?php
              include "koneksi.php";
              $sql="select*from obat order by masa_berlaku desc";
              $hasil=mysqli_query($kon,$sql);
              $no=0;
              while ($data = mysqli_fetch_array($hasil)) {
                ...
                <tbody>
                  <tr>
                    ...
                    <td>
                      <a href="obatu.php?kode_obat=<?php echo htmlspecialchars($data['kode_obat']); ?>" class="btn btn-warning" role="button"><i class='bx bxs-edit'></i>Update</a>
                      <a href="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>?kode_obat=<?php echo $data['kode_obat']; ?>" class="btn btn-danger" role="button"><i class='bx bxs-trash-alt'></i>Delete</a>
                    </td>
                  </tr>
                </tbody>
                <?php
            ...
            <a href="obatc.php" class="btn btn-primary mb-3" role="button"><i class='bx bx-plus-medical' ></i>Input Data</a>
          </div>
        </div>    
      </div>
    </div>
