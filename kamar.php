  ...
  <section class="home-section">
    <nav>
      <div class="sidebar-button">
        ...
        <span class="dashboard">List Kamar</span>
      </div>
    ...
    <div class="home-content">
      <div class="container">
        <div class="card">
          <div class="card-body">
            <h5 class="card-title mb-4" style="text-align: center;">List Kamar</h5>
            <hr>
            <?php
            include "koneksi.php";

            if (isset($_GET['no_kamar'])) {
              $no_kamar=htmlspecialchars($_GET["no_kamar"]);
            ...
            <table class="table table-bordered table-hover">
              ...
              <?php
              include "koneksi.php";
              $sql="select*from kamar order by harga desc";
              $hasil=mysqli_query($kon,$sql);
              $no=0;
              while ($data = mysqli_fetch_array($hasil)) {
                ...
                <tbody>
                  <tr>
                    ...
                    <td>
                      <a href="kamaru.php?no_kamar=<?php echo htmlspecialchars($data['no_kamar']); ?>" class="btn btn-warning" role="button"><i class='bx bxs-edit'></i>Update</a>
                      <a href="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>?no_kamar=<?php echo $data['no_kamar']; ?>" class="btn btn-danger" role="button"><i class='bx bxs-trash-alt'></i>Delete</a>
                    </td>
                  </tr>
                </tbody>
                <?php
            ...
            <a href="kamarc.php" class="btn btn-primary mb-3" role="button"><i class='bx bx-plus-medical' ></i>Input Data</a>
          </div>
        </div>    
      </div>
    </div>
