  ...
  <section class="home-section">
    <nav>
      <div class="sidebar-button">
        ...
        <span class="dashboard">List Pasien</span>
      </div>
    ...
    <div class="home-content">
      <div class="container">
        <div class="card">
          <div class="card-body">
            <h5 class="card-title mb-4" style="text-align: center;">List Pasien</h5>
            <hr>
            <?php
            include "koneksi.php";
              ...
              while ($data = mysqli_fetch_array($hasil)) {
                ...
                <tbody>
                  <tr>
                    ...
                    <td>
                      <a href="pasienu.php?id_pasien=<?php echo htmlspecialchars($data['id_pasien']); ?>" class="btn btn-warning" role="button"><i class='bx bxs-edit'></i>Update</a>
                      <a href="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>?id_pasien=<?php echo $data['id_pasien']; ?>" class="btn btn-danger" role="button"><i class='bx bxs-trash-alt'></i>Delete</a>
                    </td>
                  </tr>
                </tbody>
                <?php
            ...
            <a href="pasienc.php" class="btn btn-primary mb-3" role="button"><i class='bx bx-plus-medical' ></i>Input Data</a>
          </div>
        </div>    
      </div>
    </div>
