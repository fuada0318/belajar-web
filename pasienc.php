      ...
      <div class="container">
        <?php
          ...
          if ($_SERVER["REQUEST_METHOD"]=="POST") {
            ...
            $sql="insert into pasien (nama_pasien,tgl_lahir,alamat,jk,no_telp) values('$nama_pasien','$tgl_lahir','$alamat','$jk','$no_telp');";
        ...
        <div class="card">
          <div class="card-body">
            <h4 class="card-title" style="text-align: center;">Input Data Pasien</h4>
            <hr>
