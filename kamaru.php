...
<head>
  ...
  <title>Update Informasi Kamar</title>
  ...
  <section class="home-section">
    <nav>
      <div class="sidebar-button">
        ...
        <span class="dashboard">Update Informasi</span>
      </div>
      ...
      <div class="card">
        <div class="card-body">
         ...
         if ($_SERVER["REQUEST_METHOD"] == "POST") {
           ...
           $sql="update kamar set nama_kamar='$nama_kamar', jenis_kamar='$jenis_kamar', kapasitas='$kapasitas', harga='$harga', fasilitas='$fasilitas' where no_kamar='$no_kamar'";
        ...
        ?>
        <h5 class="card-title mt-4 mb-4" style="text-align: center;">Update Informasi Kamar</h5>
        <hr>

        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post">
          <div class="form-group">
            <label for="">Nama Kamar</label>
            <input type="text" name="nama_kamar" class="form-control" value="<?php echo $data['nama_kamar']; ?>" placeholder="Masukan Nama" required/>
          </div>
          <div class="form-group">            
          ...
          <div class="form-group">
            ...
            <input type="text" name="kapasitas" class="form-control" value="<?php echo $data['kapasitas']; ?>" placeholder="Masukan Total" required/>
          </div>
          <div class="form-group">
            <label for="">Fasilitas</label>
            <input type="text" name="fasilitas" class="form-control" value="<?php echo $data['fasilitas']; ?>" placeholder="Masukan Total" required/>
          </div>
          <div class="form-group">
            <label for="">Harga</label>
            <input type="text" name="harga" class="form-control" value="<?php echo $data['harga']; ?>" placeholder="Masukan Status" required/>
          </div>
