  ...
  <section class="home-section">
    <nav>
      <div class="sidebar-button">
        ...
        <span class="dashboard">List Dokter</span>
      </div>
    ...
    <div class="home-content">
      <div class="container">
        <div class="card">
          <div class="card-body">
            <br>
            <h5 class="card-title mb-4" style="text-align: center;">List Dokter</h5>
            <hr>
            <?php
            include "koneksi.php";
              ...
              while ($data = mysqli_fetch_array($hasil)) {
                ...
                <tbody>
                  <tr>
                    ...
                    <td><?php echo $data["id_spesialis"]; ?></td>
                    <td><?php echo $data["no_telp"]; ?></td>
                    <!-- <td><?php echo $data["date"]; ?></td> -->
                    <td><?php echo $data["alamat"]; ?></td>
                    <!-- <td><?php echo $data["updated"]; ?></td>             -->
                    <td>
                      <a href="dokteru.php?id_dokter=<?php echo htmlspecialchars($data['id_dokter']); ?>" class="btn btn-warning" role="button"><i class='bx bxs-edit'></i>Update</a>
                      <a href="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>?id_dokter=<?php echo $data['id_dokter']; ?>" class="btn btn-danger" role="button"><i class='bx bxs-trash-alt'></i>Delete</a>
                    </td>
                  </tr>
                </tbody>
                <?php
            ...
            <a href="dokterc.php" class="btn btn-primary mb-3" role="button"><i class='bx bx-plus-medical' ></i>Input Data</a>
          </div>
        </div>
      </div>
    </div>
